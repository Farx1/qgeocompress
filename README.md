...
Baseline `yolo11n-obb.pt` scores mAP50 0.8943. Generated by `scripts/frontier_study.py --preset frontier`.

| Pipeline | Params Δ | mAP50 | Δ vs baseline (95% CI) | Gate |
| -------- | -------: | ----: | ---------------------- | ---- |
| Shipped plain SVD, r=0.9 | −0.34% | 0.8715 | −0.023 [−0.061, −0.009] | pass |
| Shipped plain SVD, r=0.84 (default) | −2.29% | 0.7859 | −0.108 [−0.187, −0.044] | **fail** |
| Data-aware budget | −13.80% | 0.8900 | −0.004 [−0.022, +0.009] | pass |
| **Data-aware budget** | **−16.22%** | **0.8911** | **−0.003 [−0.021, +0.010]** | **pass — lossless** |
| Data-aware budget | −23.76% | 0.8481 | −0.046 [−0.109, −0.011] | pass |
| **Data-aware budget** | **−32.48%** | **0.8066** | **−0.088 [−0.194, −0.044]** | **pass — largest** |

Two answers, depending on what you will accept:

- **−16.2% of parameters at no measurable cost** — the confidence interval on the accuracy
  delta contains zero.
- **−32.5% inside the project's own gate** (mAP50 drop ≤ 0.10, CER@0.8 delta ≤ 0.02,
  params ≥ 2%). The shipped path reaches −0.34% before failing that same gate: **95×**.
